app.controller("RegistrationController", function ($scope, $http, $window, $cookies, cfpLoadingBar) {
    ...
    $scope.RegisterUser = function (Registration, form1) {
        ...
        if ($window.confirm("Do you want Submit Form ?")) {
            if (form1.$valid) {
                ...
                if ($scope.Dateofbirth == null || $scope.Dateofbirth == undefined) {
                    ...
                    $http.post('/Registration/Registration', data, config)
                      .success(function (data, status, headers, config) {
                          if (data == "Success")
                          {
        ...
        if ($window.confirm("Do you want Submit Form ?")) {
            if (form1.$valid) {
                ...
                if ($scope.Dateofbirth == null || $scope.Dateofbirth == undefined) {
                    ...
                    $http.post('/RegisterAdmin/Registration', data, config)
                      .success(function (data, status, headers, config) {
                          if (data == "Success") {
                              $window.location.href = "/login/login";
                          }
